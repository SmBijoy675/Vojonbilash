...
<body style=" margin:0;">
    ...
    <div class = "dashboard">
        <h1 class="account">Food Cart</h1>
        <nav>
            <a style="text-decoration: none;" href="Add to cart.php">Add Food</a>
            <a style="text-decoration: none;" href="ShowCart.php">Your Order List</a>
            <a style="text-decoration: none;" href="DeleteFood.php">Delete Order</a>
            <a style="text-decoration: none;" href="ShowInformation.php">Go Back</a>
        </nav>
    </div>
