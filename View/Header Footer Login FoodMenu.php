...
<body style=" margin:0;">
    ...
    <div class = "dashboard">
        ...
        <nav>
            <a style="text-decoration: none;" href="ShowInformation.php">Show Food Menu</a>
            <a style="text-decoration: none;" href="SearchFood.php">Search Food Suggestions</a>
            <a style="text-decoration: none" href="Add to cart.php">Food Order</a>
            <a style="text-decoration: none" href="navFood.php">Navigate Food</a>
